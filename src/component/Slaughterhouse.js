...
const Slaughterhouse_dashboard = (props) => {
      ...
      if (value === 'date') {
        setColumnchart({
          series: [
            {
              name: 'Hours',
              data: [{ x: '0-3hrs', y: details.returnables.cattle_count_perday.hr_0_3, }, { x: '4-7hrs', y: details.returnables.cattle_count_perday.hr_4_7, }, { x: '8-11hrs', y: details.returnables.cattle_count_perday.hr_8_11, }, { x: '12-15hrs', y: details.returnables.cattle_count_perday.hr_12_15, },
              {
                x: '16-19hrs',
  ...
  const Sidebar = () => {
    return (
      <div className="child"><div>       <Navbar className={navbarClass} expand="lg" fixed="top">
