...
const details = { location: { "india": 50, "china": 30, "america": 20 }, farm_name: { "variety": 10, "cultivatio": 60, "ogo": 30 }, cattle_count: { "hr_0_3": 2, "hr_4_7": 6, "hr_8_11": 12, "hr_12_15": 20, "hr_16_19": 8, "hr_20_23": 3 }, cattle_weights: { "below_100": 30, "range_100_150": 20, "more_150": 50 }, overall_report: [{ "unique_id": "PRO1", "weight": 89, "inspection": false, "farm_name": "ogo", "date_of_arrival": "30-Jan-2023", "time_of_arrival": "08:50:55", "location": "India" }, { "unique_id": "PRO2", "weight": 150, "inspection": true, "farm_name": "variety", "date_of_arrival": "30-Jan-2023", "time_of_arrival": "08:50:55", "location": "India" }, { "unique_id": "PRO3", "weight": 170, "inspection": true, "farm_name": "cultivatio", "date_of_arrival": "30-Jan-2023", "time_of_arrival": "08:50:55", "location": "India" }, { "unique_id": "PRO4", "weight": 120, "inspection": true, "farm_name": "cultivatio", "date_of_arrival": "30-Jan-2023", "time_of_arrival": "08:50:55", "location": "India" }] }
...
const Slaughterhouse_dashboard = () => {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="mx-auto">
      <Nav.Link href="#home" className="link">Slaughterhouse</Nav.Link>
    </Nav>
  </Navbar.Collapse>
</Navbar>
            <div className="container-fluid view">
                <div className="row chart">
                   ...
                   <div className="slaughter">
                        <div className="row"><img src={Fac} alt="factorys" className='img2'></img></div>
                        <div className="row">  <img src={Notes} onClick={handleClick} alt="factorys" className='img2 '></img></div>
                        <div className="row">  <img src={Edit1} alt="factorys" className='img2 '></img></div>
                        <div className="row">  <img src={Profile} alt="factorys" className='img2 '></img></div>
                        </div>
                    </div>
                    <div className="col-lg-5">{ApexChart1(details.location.india, details.location.china, details.location.america, ['India', 'China', 'America'], "LOCATION","360")}</div>
                        <div className="col-lg-6"><div >{ApexChart1(details.farm_name.cultivatio, details.farm_name.ogo, details.farm_name.variety, ["cultivatio", "ogo", "variety"], "FARM NAME","360")}</div></div>   
                </div>
                <div className="row">
